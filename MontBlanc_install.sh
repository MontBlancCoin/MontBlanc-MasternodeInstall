...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='MontBlanc.conf'
CONFIGFOLDER='/root/.MontBlanc'
COIN_DAEMON='/usr/local/bin/MontBlancd'
COIN_CLI='/usr/local/bin/Montblancd'
COIN_REPO='https://github.com/MontBlancCoin/MontBlanc/releases/download/1.0.0.1/MontBlancd'
COIN_NAME='MontBlanc'
COIN_PORT=11145
RPC_PORT=11144
